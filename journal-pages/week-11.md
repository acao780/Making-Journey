...
## Journal Review:
![checklist](../assets/week-11/week11_checklist.png)
...
Most health-tracking applications present data through graphs, numbers, and dashboards and calorie targets. While these systems can help users monitor their behaviour, they often encourage a performance-oriented mindset in which success is measured through numerical achievement. Wind Chime Garden challenges this convention by transforming food data into a personal and emotional archive that emphasises care, memory, and relationships. My project challenges this approach by transforming food data into a playful and personal visual archive. Instead of focusing on statistics alone, it uses visual storytelling, personalisation, and community interaction to make food data more meaningful and emotionally engaging.
...
![website elements](../assets/week-11/week11_design.png)
...
![50 tree versions](../assets/week-11/trees.png)
...
![final look of the website on figma](../assets/week-11/datatree_website.png)
...
![dairy book - data anaylsis, chimes detail and selected bar](../assets/week-11/detailed_design.png)
![selected bar](../assets/week-11/detailed_design1.png)
...
While using the final version of my application, I identified several areas that still require refinement. For example, some font sizes need further adjustment to improve readability, and a number of buttons could be redesigned to create a more consistent and intuitive user experience. Although the core functionality of the application has been completed, there are still minor usability and interface issues that need to be addressed. Moving forward, I plan to continue developing the application by refining the visual design, improving user interactions, and conducting further debugging to ensure a more polished and fully finished product.
