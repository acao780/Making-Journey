...
![idea_explore](../assets/week-08/week8_2.jpg)

### Workload and Reflection
After expanding the dataset to include my sister and two friends, I realised that the workload of the laser-cut concept was increasing rapidly. Originally, the system was designed around my own food diary, which only required a limited number of food pieces and calorie levels. However, once multiple participants were added, the number of food records grew significantly. Through sketching different layout options, I began estimating how many individual laser-cut components would be required. Each participant had three meals per day, and every food item needed to be represented through a separate laser-cut piece with a specific thickness based on its calorie value. This meant that a relatively small dataset could quickly result in hundreds of individual components that would need to be designed, cut, organised, and assembled. The sketches also revealed another challenge. Although the system successfully represented calorie intake, it became increasingly difficult to compare eating patterns between participants. The more food pieces I added, the more visually crowded the work became. Instead of helping viewers understand the data, the large number of components sometimes made the information harder to read. As a result, I began questioning whether the project should focus on representing every individual food item. This reflection encouraged me to think about alternative approaches that could communicate eating habits more efficiently while reducing fabrication requirements.
