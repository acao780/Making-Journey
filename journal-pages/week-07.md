...
Based on the feedback from the Concept Sketch and Creation Sprint activities, I decided to further develop the laser-cut direction of my project. One of the most useful insights from the classroom discussion was that people were much more interested in the physical representation of data than the screen-based visualisation.  She was also planing to do a 3d handmade data model. 

To move the project forward, I began developing a mapping system that converts calorie values into physical dimensions. I created a food reference table that assigns the thickness to each food item. This system allows calorie intake to be translated into a tangible form that can later be fabricated using laser cutting.
