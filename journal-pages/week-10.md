...
## 1. Progress Report
![role play](../assets/week-10/week10_1.jpg)
![anna's area](../assets/week-10/week10_2.png)
![miracle's area](../assets/week-10/week10_3.png)
![jimmy's area](../assets/week-10/week10_4.png)
![yun's area](../assets/week-10/week10_5.png)

## 2. Gallery Walk
![gallery walk](../assets/week-10/week10_like.png)
![gallery walk](../assets/week-10/week10_like1.png)
...
## Independant study
Today, I presented my project visuals and data concepts to teacher. The overall feedback was very positive. The core structure, logic, and visual presentation were approved, and teacher felt that the project was moving in a strong direction. Most of the discussion focused on the "why" behind my design decisions, particularly the purpose of the data collection and the necessity of including a community feature.

One of the first questions teacher asked was why I was collecting food intake data and what message I wanted to communicate through it. This question made me reflect deeply on the purpose of the project. Although I had collected data from myself, my family members, and a friend, I only recorded their data for a short period (22/05 onwards). My inspiration came from seeing wind chimes hanging from trees, which eventually became the foundation of the Wind Chime Garden concept.

Throughout this week, he repeatedly asked me what data I wanted to communicate and why it was important. This was difficult for me to answer because simply displaying my personal food data does not necessarily create a meaningful impact on others. During our conversations, I proposed the idea of a community where people could become involved with each other's data. However, he felt that this still did not fully answer the question.

![athlytic and health app](../assets/week-10/app.png)
...
When I arrived home, I quickly reconsidered my previous design. While keeping the core wind chime concept, I changed the structure so that each wind chime represents one day, while individual pendants represent breakfast, lunch, dinner, and additional meals or snacks. As users continue recording their meals, their trees gradually grow larger. I also introduced a shared community space where users can create their own trees and observe the growth of others. This discussion made me realise that the project is not simply about recording food intake. Many contemporary health technologies focus on monitoring calories, targets, and performance. As a result, people can become reduced to numerical measurements rather than being understood as individuals with different lifestyles and circumstances. This prompted me to rethink the role of data in my project. Rather than encouraging optimisation, I wanted the visualisation to support reflection, self-care, and empathy.

![wechat footstep](../assets/week-10/wechat_step.jpg)
...
![pikmin bloom](../assets/week-10/footstep_community.png)
...
![inspiration images](../assets/week-10/inspiration.png)
...
![econd iteration](../assets/week-10/image.png)
![detailed of the chimes](../assets/week-10/image1.png)
![food selected bar](../assets/week-10/image2.png)
![some example landscape of the garden](../assets/week-10/week10_9.png)
...
![foods](../assets/week-10/element_image.png)
